...
func solve(in *bufio.Reader, out *bufio.Writer) {
	...
	switch {
	case x >= 0 && x <= 25:
		fmt.Fprintln(out, "Interval [0,25]")
	case x > 25 && x <= 50:
		fmt.Fprintln(out, "Interval (25,50]")
	case x > 50 && x <= 75:
		fmt.Fprintln(out, "Interval (50,75]")
	case x > 75 && x <= 100:
		fmt.Fprintln(out, "Interval (75,100]")
	default:
		fmt.Fprintln(out, "Out of Intervals")
	}
}
