...
////////////////////////////////////////////////////////////////////////////////
// Recursion Time limit exceeded on test 41
...
// func GenerateFibonacciArray(n int) []int {
// 	ans := make([]int, n)
// 	for i := 0; i < n; i++ {
// 		ans[i] = Fibonacci(i)
// 	}
...
// func Fibonacci(n int) int {
// 	if n < 0 {
// 		fmt.Println("Ошибка: n должно быть неотрицательным")
// 		return -1
// 	}
...
func Fibonacci(n int64) int64 {
	...
	var previous, current, next int64
	previous = 0 // F(0)
	current = 1  // F(1)
...
func GenerateFibonacciArray(n int64) []int64 {
	ans := make([]int64, n)
	for i := int64(0); i < n; i++ {
		ans[i] = Fibonacci(i)
	}
