...
func solve(in *bufio.Reader, out *bufio.Writer) {
	...
	//fmt.Fprintln(out, binaryRepresentation)

	var cntOnes int
	for _, v := range binaryRepresentation {
		if v == '1' {
			cntOnes++
		}
	}
	...
	ans, err := strconv.ParseInt(strOnes, 2, 64)
	if err != nil {
		fmt.Fprintln(out, "Ошибка преобразования:", err)
		return
	}
