...
// Будем обрабатывать символы строки слева направо и поддерживать количество
// вопросов cnt, на которые еще не последовал ответ. Изначально это количество
// равно нулю. Пусть сейчас мы рассматриваем i-й символ строки. Если он равен
// «Q», увеличим количество вопросов cnt на единицу. Если он равен «A», уменьшим
// количество вопросов cnt на единицу. Если cnt стало меньше нуля, то какой-то
// из вопросов получил несколько сообщений в ответ. В этом случае обнулим cnt

// Если после обработки всей строки cnt
// равно нулю, то все сообщения клиента получили ответ от менеджера, а значит
// нужно вывести «Yes». В противном случае нужно вывести «No».

// Асимптотика: O(n)
// на каждый набор входных данных.
