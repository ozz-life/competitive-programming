...
// Пусть максимум из очков Якко и Вакко -- a. Тогда Дот выиграет, если выбросит
// не меньше a очков. Вероятность этого равна (6 - (a-1)) / 6. Поскольку a
// принимает всего 6 значений, ответы можно просто вычислить вручную.
