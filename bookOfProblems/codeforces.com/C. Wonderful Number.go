...
func IsWonderfulNumber(x int) bool {
	if IsOdd(x) {
		binaryRepresentation := strconv.FormatInt(int64(x), 2)
		isPalindrome := StringIsPalindrome(binaryRepresentation)
		if isPalindrome {
			return true
		} else {
			return false
