...
void solve()
{
    int n;
    cin >> n;
    std::vector<int> v1(n), v2(n - 1), v3(n - 2);
    ...
    int sv1 = std::accumulate(v1.begin(), v1.end(), 0);
    int sv2 = std::accumulate(v2.begin(), v2.end(), 0);
    int sv3 = std::accumulate(v3.begin(), v3.end(), 0);
