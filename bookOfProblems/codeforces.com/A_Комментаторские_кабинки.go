...
func solve(in *bufio.Reader, out *bufio.Writer) {
	...
	// n mod m = остаток от деления n на m, то есть число, которое остаётся
	// после того, как n делится на m

	// m - (n mod m) = остаток от деления m на n. Или расстояние от текущего
	// значения n mod m, до ближайшего целого, кратного m
