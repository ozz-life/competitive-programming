...
// Будем последовательно строить матрицу, проходя сверху вниз, слева направо. В
// текущий момент мы находимся в позиции (i, j). Посмотрим на содержимое клеток
// a[i][j] и a[j][i]. Если количество нулей в них не превосходит k, то заполним
// ячейки единицами и уменьшим k на количество поставленных единиц.

// Если после обхода всей матрицы k не стало нулем, то ответа не существует.
