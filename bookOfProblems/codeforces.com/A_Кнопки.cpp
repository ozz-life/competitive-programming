...
void solve()
{
	...
	// if(a == b and c % 2 == 0) cout << "Second\n";
	// else if(a == b and c % 2 != 0) cout << "First\n";
	// else if(a + c > b and c % 2 == 0) cout << "First\n";
	// else if(b + c > a and c % 2 != 0) cout << "Second\n";
	// else if(a + c > b) cout << "First\n";
	// else if(b + c > a) cout << "Second\n";
	
	// чётная, всегда заканчивается на Кате
	if(c % 2 == 0) {
		if(b > a) cout << "Second\n";
		else if (b < a) cout << "First\n";
		else cout << "Second\n";
	}
	// Заканчивается на Ане
	else if(c == 1) {
		if(a > b) cout << "First\n";
		else if(a < b) cout << "Second\n";
		else cout << "First\n";
	}
	// Заканчивается на Кате
	else if (c % 2 != 0) {
		if(b > a) cout << "Second\n";
		else if (b < a) cout << "First\n";
		else cout << "First\n";
