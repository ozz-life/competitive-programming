...
void solve() {
	...
	// cout << "floor " << a << " / " << b << " = " << std::floor(a / b) << endl;
	// cout << "ceil " << a << " / " << b << " = " << std::ceil(a / b) << endl;
	// cout << "round " << a << " / " << b << " = " << std::round(a / b) << endl;
	
	cout << "floor " << a << " / " << b << " = " << int(a) / int(b) << endl;
	//cout << "ceil " << a << " / " << b << " = " << int(a + b - 1) / int(b) << endl;
	cout << "ceil " << a << " / " << b << " = " << int((a + b - 1) / (b)) << endl;
	cout << "round " << a << " / " << b << " = " << std::round(a / b) << endl;
}
