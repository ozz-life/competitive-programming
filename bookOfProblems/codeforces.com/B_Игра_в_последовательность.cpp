...
void solve() {
  ...
  //   a.push_back(b[0]); // Первый элемент всегда добавляется
  ...
  //       count++;
  //     } else {
  //       a.push_back(b[i]); // Добавление текущего элемента
  //       a.push_back(b[i]); // И добавление его еще раз, так как он меньше
  //       предыдущего count += 2;
  //     }
  //   }
