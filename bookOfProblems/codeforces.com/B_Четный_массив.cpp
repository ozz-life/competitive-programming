...
// Разделим все позиции, в которых четность индекса не совпадает с чётностью
// элемента. Если в чётном индексе, находится нечётное число, добавим этот
// индекс в массив e. Иначе, если в нечётном индексе находится чётное число,
// добавим этот индекс в массив o. Заметим, что если размеры массивов o и e не
// совпадают, то ответа не существует. В противном случае массив a можно сделать
// хорошим за |o| операций, просто поменяв местами все элементы в массивах o и
// e.
