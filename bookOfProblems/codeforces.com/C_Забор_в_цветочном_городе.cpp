...
void solve() {
  ...
  //   for (int i = 0; i < boardHeights[n - 1]; i++)
  //     expectedHeights.push_back(n);

  //   for (int i = n - 2; i >= 0; i--) {
  //     for (int j = 0; j < (boardHeights[i] - boardHeights[i + 1]); j++)
  //       expectedHeights.push_back(i + 1);
  //   }

  //   for (int i = 0; i < n; i++)
  //     if (boardHeights[i] != expectedHeights[i]) {
  //       cout << "NO"
  //            << "\n";
  //       return;
  //     }
