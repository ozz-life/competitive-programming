...
{ 
    ...
    // 4 1 1 means you need to make 4 copies answer is 3 because in first second you make 1 copy of original one now you have 2 copies in total so now you can make copies from both machines..
}
