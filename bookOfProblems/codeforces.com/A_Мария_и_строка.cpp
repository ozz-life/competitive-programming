...
// Проверка чётности не будет работать при стандарте кодирования целых чисел
// Ones' complement не будет работать.
...
void solve() {
  ...
  // } else {
  //     if (cntA > 0) {
  //         char replaceChar = (cntA > n - cntA) ? 'A' : 'B';
  //         for (int i = 0; i < n; i++) {
  //             s[i] = replaceChar;
  //             cout << 1 << "\n" << i + 1 << " " << replaceChar << "\n";
  //         }
