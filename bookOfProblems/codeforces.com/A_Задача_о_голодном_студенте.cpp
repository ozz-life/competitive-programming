...
// Существует много способов решить эту задачу. Один из самых простых —
// перебрать a и b от 0 до 33 и проверить, что 3a + 7b = x.
...
//   cin >> x;
//   bool flag = 0;
//   for (int j = 0; j < x && j * 3 <= x; ++j) {
//     for (int z = 0; z < x && j * 3 + z * 7 <= x; ++z) {
//       if (j * 3 + z * 7 == x) {
//         cout << "YES\n";
//         flag = 1;
//         break;
...
//   cin >> x;
//   bool flag = 0;
//   for (int a = 0; a < 100 && !flag; ++a)
//     for (int b = 0; b < 100 && !flag; ++b) {
//       if (3 * a + 7 * b == x) {
//         cout << "YES\n";
//         flag = 1;
//         break;
