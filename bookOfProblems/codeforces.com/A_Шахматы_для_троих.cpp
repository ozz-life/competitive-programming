...
// Эта задача просто на реализацию. Поддерживаем номер текущего зрителя и
// проверяем, что победил не он. Если знать, что текущий победитель — w, а
// текущий зритель — s, можно легко получить третьего игрока по формуле
// 6 - w - s (сумма всех номеров без двух известных).
