...
// Заметим, что в конечном расположении все высоты столбиков расположены в
// неубывающем порядке. Также, количество столбиков каждой высоты остаётся
// неизменным. Это означает, что ответом является упорядоченная
// последовательность данных высот столбиков.
