...
// Случай 0
// 3 1 1
// Подсчитать только единицы ИЛИ если все элементы, кроме последнего == 1

// Случай 1
// k = 5 // 3 2
// + 1

// - a[i] >= 2 и разделить на 1 и a[i] - 1, количество кусков увеличится на 1
// - SELECT (a[i] && a[j] == 1) WHERE (a[i] != a[j]) и соединить в кусок a[i]+1,
// количество кусков увеличиться
// return MinOperations
func solve(in *bufio.Reader, out *bufio.Writer) {
	var n, k int // n - длина в метрах, k - количество палок
	fmt.Fscan(in, &n, &k)
