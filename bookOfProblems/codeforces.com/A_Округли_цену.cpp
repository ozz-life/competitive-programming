...
// Заметим, что число m и ближайшее к нему круглое число, не превышающее m имеют
// одинаковый размер (состоят из одинакового количества цифр в записи).
// Обозначим размер числа m за len. Тогда можем сконструировать ближайшее
// круглое число. Оно будет состоять из единицы и len−1 нулей.
