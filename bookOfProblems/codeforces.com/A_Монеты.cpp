...
// Заметим, что 2
// монеты номинала k, можно заменить на k монет номинала 2. А значит, если ответ существует,
// то существует и такой набор монет, где не больше одной монеты номинала k.
// Поэтому достаточно перебрать количество монет номинала k (от 0 до 1) и проверить,
// что оставшееся количество неотрицательно и четно
// (т. е. его можно представить в виде набора монет номинала 2).
void solve()
{
    int64_t n, k;
    cin >> n >> k;
