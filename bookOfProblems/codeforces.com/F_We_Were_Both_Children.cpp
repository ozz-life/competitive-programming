...
void solve() {
  ...
  // Отладочный вывод: выводим входные данные
  //  cout << "Input data: ";
  //  for (auto x : a)
  //    cout << x << " ";
  //  cout << endl;
  ...
  // Отладочный вывод: выводим частоты длин прыжков
  // cout << "Frequencies: ";
  // for (int i = 1; i <= n; i++)
  //   cout << freq[i] << " ";
  // cout << endl;
  ...
  // Отладочный вывод: выводим значения trap
  // cout << "Trap values: ";
  // for (int i = 1; i <= n; i++)
  //   cout << trap[i] << " ";
  // cout << endl;

  cout << *max_element(trap.begin(), trap.end()) << '\n';
}
