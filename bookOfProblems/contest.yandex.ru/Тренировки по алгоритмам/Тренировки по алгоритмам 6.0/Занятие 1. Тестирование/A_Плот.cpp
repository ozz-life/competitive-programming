...
// void solve() {
//   int x1, y1; // координаты юго-западного угла плота (A)
//   int x2, y2; // координаты северо-восточного угла плота (C)
//   int x, y;   // координаты пловца, ВНЕ плота
//   std::cin >> x1 >> y1 >> x2 >> y2 >> x >> y;

//   Point A(x1, y1); // Юго-западный угол
//   Point C(x2, y2); // Северо-восточный угол
//   Point B(x1, y2); // Северо-западный угол
//   Point D(x2, y1); // Юго-восточный угол

//   // 16 if
//   if (x == B.x && y > B.y) {
//     std::printf("N");
//   }
//   if ((x > B.x && x < C.x) && y > B.y) {
//     std::printf("N");
//   }
//   if (x == C.x && y > C.y) {
//     std::printf("N");
...
//   //   std::printf("Coordinates of rectangle corners:\n");
//   //   std::printf("A (Southwest corner): (%d, %d)\n", A.x, A.y);
//   //   std::printf("B (Northwest corner): (%d, %d)\n", B.x, B.y);
//   //   std::printf("C (Northeast corner): (%d, %d)\n", C.x, C.y);
//   //   std::printf("D (Southeast corner): (%d, %d)\n", D.x, D.y);
// }
