...
std::vector<int64_t> findPrefixSums(vector<int64_t> a) {
  int64_t n = a.size();
...
//   vector<int64_t> prefixSum = findPrefixSums(a);

//   int64_t maxSum = a[0];
//   int64_t minPrefixSum = 0;
//   for (int r = 1; r <= n; ++r) {
//     maxSum = max(maxSum, prefixSum[r] - minPrefixSum);
...
//   for (int r = 1; r <= n; ++r) {
//     cout << "r = " << r << endl;
//     cout << "prefixSum[" << r << "] = " << prefixSum[r] << endl;
//     cout << "minPrefixSum = " << minPrefixSum << endl;
//     maxSum = max(maxSum, prefixSum[r] - minPrefixSum);
//     cout << "maxSum = " << maxSum << endl;
//     minPrefixSum = min(minPrefixSum, prefixSum[r]);
//     cout << "minPrefixSum updated to " << minPrefixSum << endl;
//   }
