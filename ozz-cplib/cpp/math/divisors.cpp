...
std::vector<int64_t> MathFindAllDivisors__N(int64_t n) {
...
std::vector<int64_t> MathFindAllDivisors__Sqrt(int64_t n) {
  std::vector<int64_t> divisors;
...
void preprocessDivisorsCount(int max_n, vector<int64_t> &divisors_count) {
...
void solve() {
  ...
  std::vector<int64_t> divisors_count(max_n + 1, 0);
  preprocessDivisorsCount(max_n, divisors_count);

  int64_t n;
  std::cin >> n;
  //std::vector<int64_t> divisors = MathFindAllDivisors__v1(n);
