...
// int rec(int idx, int k) // idx - индекс текущей клетки, k - количество поставленных фишек
// {
//     // блок выхода из рекурсии
//     // в векторе a содержится текущая расстановка
...
//         rec(idx + 1, k + 1);
//     }
//     // пробуем оставить клетку свободной 
//     a[idx] = '.'; 
//     rec(idx + 1, k);
// }
...
// void place_chips(int n, int m, int idx, std::vector<char> &board)
// {
//     if (idx == n)
//     {
//         for (int i = 0; i < n; ++i)
...
//     {
//         board[idx] = '*';
//         place_chips(n, m - 1, idx + 1, board);
//     }

//     board[idx] = '.';
//     place_chips(n, m, idx + 1, board);
// }
...
void solve(){
	int n = 25, m = 8, num = 24008, counter = 1;
	string s(n, '.');
