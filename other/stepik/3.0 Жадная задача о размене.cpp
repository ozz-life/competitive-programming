...
// a - вектор номиналов, упорядоченный в порядке убывания
// s - сумма, которую нужно набрать
...
//   std::vector<int> a = {4, 2, 1};
  int s = 25;
  std::vector<int> a = {10, 8, 6, 1};
//   int s = 26;
//   std::vector<int> a = {10, 5, 2, 1};

  cout << change(a.size(), a, s);
}
